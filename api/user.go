...
type createUserRequest struct {
	Username	string	`json:"username" binding:"required,alphanum"`	Password	string	`json:password binding:"required,min=6"`	FullName	string	`json:"full_name" binding:"required"`
